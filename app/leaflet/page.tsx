...
export default function LandingPage() {
  ...
  const [campaignSource, setCampaignSource] = useState<string>('QR Leaflet Scan');
  ...
  useEffect(() => {
    async function trackVisitor() {
      try {
        ...
        // Get campaign source - prioritize referral, email, SMS, then UTM, then default to QR Leaflet Scan
        let sourceName = 'QR Leaflet Scan'; // Default for /leaflet page
        if (ref) {
        ...
        {step === 1 && (
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-2" style={{ color: '#1f3a33' }}>
              Claim Your £50 Voucher<br />& Book an Appointment Now
            </h1>

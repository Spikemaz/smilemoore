        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="/home#services" className="text-gray-700 hover:text-blue-600">Services</a>
              <a href="/home#about" className="text-gray-700 hover:text-blue-600">About</a>
              <a href="/home#contact" className="text-gray-700 hover:text-blue-600">Contact</a>
            </div>
